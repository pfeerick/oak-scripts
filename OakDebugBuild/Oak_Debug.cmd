...
:run_esptool
esptool --baud 115200 --port COM%COMPort% write_flash -fs 32m 0x1000 blank.bin 0x0002000 OakSystem_debug.bin 0x0081000 oakupdate_restore.bin 0x101000 blank.bin 0x102000 blank.bin 0x202000 blank.bin 
goto end
